function [sys,x0,str,ts] = sSATanim2(t,x,u,flag,Config)
...
%
   ...
   h_f=findobj('type','figure','Tag','6DOF anim','Color','k');
...
set(handle.target2,'linestyle','-','color',[1 0 0],'linewidth',2);
...
set(handle.target2,'linestyle','-','color',[0 0 .8],'linewidth',4);
...
text(10000,100,100,'X');
text(100,10000,100,'Y');
text(100,100,10000,'Z');
%
